...
export default function Image() {
  return new ImageResponse(
    (
      <div style={{background: "linear-gradient(135deg, #0d1b32 0%, #142b4d 100%)", height: "100%", width: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "64px 72px", color: "#f6f8fa"}}>
        <div style={{display: "flex", alignItems: "center", gap: 14}}>
          <div style={{width: 34, height: 34, border: "4px solid #14b8c4", display: "flex"}} />
        ...
        <div style={{display: "flex", flexDirection: "column"}}>
          <span style={{fontSize: 26, color: "#14b8c4", fontWeight: 700, textTransform: "uppercase", letterSpacing: 2, marginBottom: 16}}>Techno Blog</span>
        ...
        <div style={{display: "flex", alignItems: "flex-end", gap: 5, height: 46}}>
          {WAVE.map((h, i) => (
            <div key={i} style={{width: 8, height: Math.round(h * 0.5), background: "rgba(20,184,196,0.6)", borderRadius: 4}} />
          ))}
        </div>
      </div>
    ),
